 ...
 * photos or video. This token carries just enough for the receiver to join the
 * sender's Wi-Fi Direct group, over which the actual file is streamed.
 *
...
enum class HandshakeRole {
    /** Holds the file and initiates the Wi-Fi Direct group. */
    SENDER,

    /** Joins the sender's group and receives the file. */
    RECEIVER,
}
